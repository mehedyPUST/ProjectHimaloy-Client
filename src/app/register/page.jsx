            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
                        <span>💰</span>
                        <span>Welcome to ProjectHimaloy</span>
                    </div>
                        ...
                        <div className="p-6 md:p-8">
                            <Form className="flex flex-col gap-5" onSubmit={onSubmit}>
                                    ...
                                    >
                                        {imagePreview ? (
                                            ...
                                            <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center border-2 border-dashed border-blue-300 hover:border-blue-400 transition-colors">
                                                <MdCloudUpload className="w-8 h-8 text-blue-400" />
                                            </div>
                                        )}
                                    </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        <MdCalendarToday className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 z-10" size={18} />
                                        <input
                                            type="date"
                                            name="dob"
                                            value={dob}
                                ...
                                >
                                    {isLoading || uploading ? "Creating..." : "Create Account"}
                                </Button>
                            </Form>
                            ...
                            <Button
                                ...
                                className="w-full border-2 border-gray-200 bg-white text-gray-700 font-semibold hover:bg-gray-50 transition-all h-12"
                                disabled={isLoading}
                            >
