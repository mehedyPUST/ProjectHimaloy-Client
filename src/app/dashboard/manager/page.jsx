    ...
    if (!isManager) {
        return (
            <div className="flex justify-center items-center min-h-[400px]">
                <div className="text-center bg-white rounded-xl border border-gray-200 p-12 max-w-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-5">
                    ...
                    <p className="text-2xl font-bold text-gray-900 mt-3">
                        ৳{dashboardData.totalCollectionThisMonth.toLocaleString()}
                    </p>
                    <p className="text-sm text-gray-500">
                        of ৳{dashboardData.expectedCollection.toLocaleString()} collected
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-5">
                    ...
                    <div className="space-y-2">
                        <Link href="/dashboard/manager/deposits" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <Link href="/dashboard/manager/loans" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            <div className="flex items-center gap-3">
                        ...
                        <Link href="/dashboard/manager/votings" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            <div className="flex items-center gap-3">
                        ...
                        <Link href="/dashboard/manager/meetings" className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            <div className="flex items-center gap-3">
